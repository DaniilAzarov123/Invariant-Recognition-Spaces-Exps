...
let expName = '4AFC';  // from the Builder filename that created this script
let expInfo = {
    'Prolific_ID': '',
    'Age': '',
    'Gender': '',
...
async function updateInfo() {
  ...
  psychoJS.setRedirectUrls('https://app.prolific.com/submissions/complete?cc=C7783X4O', '');
...
function pic_remeberingLoopBegin(pic_remeberingLoopScheduler, snapshot) {
  return async function() {
    ...
    for (const thisPic_remebering of pic_remebering) {
