...
let expName = '2AFC_2';  // from the Builder filename that created this script
let expInfo = {
    'Prolific_ID': '',
    'Age': '',
    'Gender': '',
...
psychoJS.start({
  ...
  resources: [
    // resources:
    {'name': '2AFC_2.xlsx', 'path': '2AFC_2.xlsx'},
...
async function updateInfo() {
  ...
  psychoJS.setRedirectUrls('https://app.prolific.com/submissions/complete?cc=C16KZJ6S', '');
