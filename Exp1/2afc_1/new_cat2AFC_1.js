...
let expName = 'new_cat2AFC_1';  // from the Builder filename that created this script
...
psychoJS.start({
  ...
  expInfo: expInfo,
  resources: [ 
      {'name': '2AFC_1.xlsx', 'path': 'resources/2AFC_1.xlsx'},
...
async function updateInfo() {
  ...
  psychoJS.setRedirectUrls('https://app.prolific.co/submissions/complete?cc=57E10F04', '');
