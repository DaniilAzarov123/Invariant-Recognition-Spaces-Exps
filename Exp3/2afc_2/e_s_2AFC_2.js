...
let expName = 'e_s_2AFC_2';  // from the Builder filename that created this script
...
psychoJS.start({
  ...
  expInfo: expInfo,
  resources: [
      {'name': 'stims_exp2.xlsx', 'path': 'resources/stims_exp2.xlsx'},
...
async function updateInfo() {
  ...
  psychoJS.setRedirectUrls('https://app.prolific.co/submissions/complete?cc=CG7F5IMA', '');
